# Configure applications with ConfigMaps and Secrets — Inferno

## Incident

A platform team reports a failure involving **configure applications with configmaps and secrets**. Several symptoms may have the same apparent cause.
