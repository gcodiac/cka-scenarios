# Manage and evaluate container output — Inferno

## Incident

A platform team reports a failure involving **manage and evaluate container output**. Several symptoms may have the same apparent cause.
