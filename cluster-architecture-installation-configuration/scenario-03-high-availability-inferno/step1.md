# Manage a highly available Kubernetes cluster — Inferno

## Incident

A platform team reports a failure involving **manage a highly available kubernetes cluster**. Several symptoms may have the same apparent cause.
