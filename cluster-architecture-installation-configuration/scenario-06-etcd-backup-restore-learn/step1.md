# Implement etcd backup and restore — Learn

## The objective

Implement etcd backup and restore is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
