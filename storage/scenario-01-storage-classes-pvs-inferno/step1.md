# Use StorageClasses and PersistentVolumes — Inferno

## Incident

A platform team reports a failure involving **use storageclasses and persistentvolumes**. Several symptoms may have the same apparent cause.
