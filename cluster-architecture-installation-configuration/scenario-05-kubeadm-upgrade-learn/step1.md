# Perform a Kubernetes version upgrade with kubeadm — Learn

## The objective

Perform a Kubernetes version upgrade with kubeadm is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
