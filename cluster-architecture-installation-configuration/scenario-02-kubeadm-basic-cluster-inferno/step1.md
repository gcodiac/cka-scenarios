# Use kubeadm to install a basic cluster — Inferno

## Incident

A platform team reports a failure involving **use kubeadm to install a basic cluster**. Several symptoms may have the same apparent cause.
