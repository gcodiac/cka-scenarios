# Configure applications with ConfigMaps and Secrets — Learn

## The objective

Configure applications with ConfigMaps and Secrets is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
