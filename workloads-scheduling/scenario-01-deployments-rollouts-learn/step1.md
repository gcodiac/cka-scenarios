# Deployments, rolling updates, and rollbacks — Learn

## The objective

Deployments, rolling updates, and rollbacks is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
