# Troubleshoot Services and networking — Inferno

## Incident

A platform team reports a failure involving **troubleshoot services and networking**. Several symptoms may have the same apparent cause.
