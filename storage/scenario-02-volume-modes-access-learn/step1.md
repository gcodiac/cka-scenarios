# Understand volume modes, access modes, and reclaim policies — Learn

## The objective

Understand volume modes, access modes, and reclaim policies is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
