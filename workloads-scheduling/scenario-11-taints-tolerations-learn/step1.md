# Use taints and tolerations — Learn

## The objective

Use taints and tolerations is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
