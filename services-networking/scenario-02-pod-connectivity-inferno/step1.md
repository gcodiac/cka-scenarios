# Understand connectivity between Pods — Inferno

## Incident

A platform team reports a failure involving **understand connectivity between pods**. Several symptoms may have the same apparent cause.
