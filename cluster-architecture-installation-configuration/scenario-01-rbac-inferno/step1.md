# Manage Role-Based Access Control (RBAC) — Inferno

## Incident

A platform team reports a failure involving **manage role-based access control (rbac)**. Several symptoms may have the same apparent cause.
