# Schedule workloads with resource requirements — Inferno

## Incident

A platform team reports a failure involving **schedule workloads with resource requirements**. Several symptoms may have the same apparent cause.
