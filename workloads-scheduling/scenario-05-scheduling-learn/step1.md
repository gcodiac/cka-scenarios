# Schedule workloads with resource requirements — Learn

## The objective

Schedule workloads with resource requirements is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
