# Configure and use multiple schedulers — Inferno

## Incident

A platform team reports a failure involving **configure and use multiple schedulers**. Several symptoms may have the same apparent cause.
