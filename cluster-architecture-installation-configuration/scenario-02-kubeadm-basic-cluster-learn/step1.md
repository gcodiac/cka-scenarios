...
Use kubeadm to install a basic cluster is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
