# Configure Kubernetes Services — Inferno

## Incident

A platform team reports a failure involving **configure kubernetes services**. Several symptoms may have the same apparent cause.
