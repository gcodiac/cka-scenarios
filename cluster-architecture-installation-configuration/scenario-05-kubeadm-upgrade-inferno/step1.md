# Perform a Kubernetes version upgrade with kubeadm — Inferno

## Incident

A platform team reports a failure involving **perform a kubernetes version upgrade with kubeadm**. Several symptoms may have the same apparent cause.
