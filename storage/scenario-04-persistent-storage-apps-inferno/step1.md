# Configure applications with persistent storage — Inferno

## Incident

A platform team reports a failure involving **configure applications with persistent storage**. Several symptoms may have the same apparent cause.
