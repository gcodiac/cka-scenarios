# Use StorageClasses and PersistentVolumes — Learn

## The objective

Use StorageClasses and PersistentVolumes is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
