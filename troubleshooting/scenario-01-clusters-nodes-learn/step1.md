# Troubleshoot clusters and nodes — Learn

## The objective

Troubleshoot clusters and nodes is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
