# Monitor cluster and application resource usage — Learn

## The objective

Monitor cluster and application resource usage is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
