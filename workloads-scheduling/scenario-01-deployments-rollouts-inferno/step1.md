# Deployments, rolling updates, and rollbacks — Inferno

## Incident

A platform team reports a failure involving **deployments, rolling updates, and rollbacks**. Several symptoms may have the same apparent cause.
