# Use static Pods — Production

## Operational task

Apply **use static pods** to a production-style workload or cluster component. Keep the public contract stable: preserve resource names, namespaces, ports, access boundaries, and availability unless the task explicitly changes them.
