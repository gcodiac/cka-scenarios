# Provision underlying infrastructure for Kubernetes — Inferno

## Incident

A platform team reports a failure involving **provision underlying infrastructure for kubernetes**. Several symptoms may have the same apparent cause.
