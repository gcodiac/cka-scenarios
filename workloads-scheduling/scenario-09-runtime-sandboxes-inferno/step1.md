# Configure container runtime sandboxes — Inferno

## Incident

A platform team reports a failure involving **configure container runtime sandboxes**. Several symptoms may have the same apparent cause.
