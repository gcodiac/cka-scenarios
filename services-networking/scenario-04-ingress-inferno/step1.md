# Use Ingress controllers and Ingress resources — Inferno

## Incident

A platform team reports a failure involving **use ingress controllers and ingress resources**. Several symptoms may have the same apparent cause.
