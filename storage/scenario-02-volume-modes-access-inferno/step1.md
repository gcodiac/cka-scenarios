# Understand volume modes, access modes, and reclaim policies — Inferno

## Incident

A platform team reports a failure involving **understand volume modes, access modes, and reclaim policies**. Several symptoms may have the same apparent cause.
