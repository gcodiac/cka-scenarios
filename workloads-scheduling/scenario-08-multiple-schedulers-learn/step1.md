# Configure and use multiple schedulers — Learn

## The objective

Configure and use multiple schedulers is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
