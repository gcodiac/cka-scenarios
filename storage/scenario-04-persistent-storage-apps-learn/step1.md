# Configure applications with persistent storage — Learn

## The objective

Configure applications with persistent storage is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
