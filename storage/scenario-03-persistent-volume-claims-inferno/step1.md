# Use PersistentVolumeClaims — Inferno

## Incident

A platform team reports a failure involving **use persistentvolumeclaims**. Several symptoms may have the same apparent cause.
