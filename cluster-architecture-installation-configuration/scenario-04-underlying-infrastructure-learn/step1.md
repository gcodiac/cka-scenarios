# Provision underlying infrastructure for Kubernetes — Learn

## The objective

Provision underlying infrastructure for Kubernetes is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
