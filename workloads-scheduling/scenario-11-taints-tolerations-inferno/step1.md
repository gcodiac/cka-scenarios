# Use taints and tolerations — Inferno

## Incident

A platform team reports a failure involving **use taints and tolerations**. Several symptoms may have the same apparent cause.
