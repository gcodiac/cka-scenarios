# Use Ingress controllers and Ingress resources — Learn

## The objective

Use Ingress controllers and Ingress resources is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
