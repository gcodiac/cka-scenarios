# Manage and evaluate container output — Learn

## The objective

Manage and evaluate container output is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
