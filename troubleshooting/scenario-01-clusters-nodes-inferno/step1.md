# Troubleshoot clusters and nodes — Inferno

## Incident

A platform team reports a failure involving **troubleshoot clusters and nodes**. Several symptoms may have the same apparent cause.
