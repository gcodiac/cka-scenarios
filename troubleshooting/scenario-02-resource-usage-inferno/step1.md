# Monitor cluster and application resource usage — Inferno

## Incident

A platform team reports a failure involving **monitor cluster and application resource usage**. Several symptoms may have the same apparent cause.
