# Configure container runtime sandboxes — Learn

## The objective

Configure container runtime sandboxes is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
