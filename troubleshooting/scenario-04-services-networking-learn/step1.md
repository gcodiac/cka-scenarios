# Troubleshoot Services and networking — Learn

## The objective

Troubleshoot Services and networking is a CKA task: understand the API objects, the node or control-plane boundary involved, and the evidence that proves the result.
